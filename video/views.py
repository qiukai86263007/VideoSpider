...
like_request_body=openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        'video_id': openapi.Schema(type=openapi.TYPE_INTEGER, description='Video ID'),
    }
)
@swagger_auto_schema(operation_description="Like a video",
                     request_body=like_request_body,
                     responses={200: 'x'})
@ajax_required
